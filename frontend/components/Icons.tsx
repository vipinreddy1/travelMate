...
// Compass icon for TripMind logo
...
// Sparkle icon for DNA preference
...
// Mic icon
export function MicIcon({ size = 24, className, isActive = false, ...props }: MicIconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function StarIcon({ size = 18, filled = false, className, ...props }: StarIconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function PlaneIcon({ size = 20, className, ...props }: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M22 16.13v-5.3l-8.5-6.33L5.5 10.83v5.3L22 16.13z" />
      <path d="M1.07 11.27l5.01 3.57 1.25-2.58" />
      <path d="M22.93 11.27l-5.01 3.57-1.25-2.58" />
    </svg>
  )
}

// Hotel icon
export function HotelIcon({ size = 20, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
